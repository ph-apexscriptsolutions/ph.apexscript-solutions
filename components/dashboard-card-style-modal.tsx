...
export function DashboardCardStyleModal({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-2 sm:p-4 bg-black/60 backdrop-blur-sm overflow-y-auto">
      ...
      <div className="relative z-10 w-full max-w-2xl rounded-2xl border border-zinc-200 bg-white shadow-2xl flex flex-col max-h-[95vh] sm:max-h-[90vh] my-auto overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        
        {/* Header */}
        <div className="shrink-0 flex items-center justify-between border-b border-zinc-200 px-4 sm:px-6 py-3 sm:py-4 bg-gradient-to-r from-zinc-50 to-white">
          <div className="flex items-center gap-2.5">
            <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-cyan-100 text-cyan-700 shadow-sm">
              <Paintbrush className="h-5 w-5" />
            </div>
            <div>
              <h3 className="text-sm sm:text-base font-bold text-zinc-900">{title}</h3>
        ...
        {/* Modal Footer */}
        <div className="shrink-0 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 border-t border-zinc-200 px-4 sm:px-6 py-3 sm:py-4 bg-zinc-50">
          <button
            onClick={onReset}
            className="inline-flex items-center justify-center gap-1.5 rounded-xl border border-zinc-300 bg-white px-4 py-2 text-xs font-semibold text-zinc-700 hover:bg-zinc-100 transition shadow-sm"
          >
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={onClose}
              className="flex-1 sm:flex-none rounded-xl px-4 py-2 text-xs font-semibold text-zinc-600 hover:bg-zinc-200 transition"
            >
              Cancel
            </button>
            <button
              ...
              className="flex-1 sm:flex-none inline-flex items-center justify-center gap-1.5 rounded-xl bg-gradient-to-r from-cyan-600 to-sky-600 px-5 py-2 text-xs font-bold text-white shadow-lg shadow-cyan-600/30 hover:from-cyan-700 hover:to-sky-700 transition"
            >
