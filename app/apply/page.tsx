      ...
      <div className="relative z-10 min-h-screen py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="text-center mb-6">
            ...
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-red-500 to-rose-500 text-white px-4 py-2 rounded-full text-sm font-semibold shadow-lg shadow-red-500/30 mb-3">
            ...
            <div className="p-5">
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-cyan-500 via-cyan-600 to-sky-600 text-white font-bold py-3 px-6 rounded-lg hover:from-cyan-600 hover:via-cyan-700 hover:to-sky-700 transition-all shadow-lg shadow-cyan-500/30 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 text-sm"
                >
                  {isSubmitting ? (
                    <>
